import os
files = os.listdir('../projects/GTEX_eSTRs/data/RNA-Seq/')
...
#
    os.system(command)
    command = "awk 'FNR==NR {a[$1]=$0; next}; $1 in a {print a[$1]}' Rpkm  protein_coding_IDs > /storage/szfeupe/data/Expression_by_Tissue/"+file+"_rpkm"
    os.system(command)
    os.system("rm Rpkm")
