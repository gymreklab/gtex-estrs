#!/usr/bin/env python
"""
Annotate merged causality score table with distance to UTRs and locations of target gene
USAGE: annotate_feature_UTRs.py  OUTDIR  GENEANNOT > $OUTDIR/features/GTEx_merged_causality_UTRs.tab
"""
...
tmpdata[["gene","chrom","best.str.start","best.score","best.tissue","best.q","dist.to.tss","dist.to.tes"]].to_csv(sys.stdout, sep="\t", index=False)
