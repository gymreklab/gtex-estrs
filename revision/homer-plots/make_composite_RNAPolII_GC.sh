...
POL2="${TAGDIR}/POLR2A_GM12878 ${TAGDIR}/polr2a-chipseq-heart-ENCFF643EGO ${TAGDIR}/polr2a-chipseq-lung-ENCFF719ANC ${TAGDIR}/polr2a-chipseq-tibial_nerve-ENCFF750HDH"
